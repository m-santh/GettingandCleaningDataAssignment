...
### Explanation of files used from original data sets

The downloaded dataset contained the following files that were used to create the tidy data:
...
4. Selected only those columns that measure the mean and standard deviation for each measurement.
5. Melted the data set based on subjects identifier and activity type for all of the selected measurements.
6. Casted the melted data set to compute the mean for each of the variables based on subjects identified and activity type.
